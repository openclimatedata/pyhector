...
# -*- coding: utf-8 -*-
#
# pyhector documentation build configuration file, created by
...
# ones.
extensions = ["sphinx.ext.autodoc", "sphinx.ext.autosummary", "sphinx.ext.todo", "sphinx.ext.napoleon"]
...
latex_documents = [(master_doc, "pyhector.tex", "pyhector Documentation", "Sven Willner, Robert Gieseke", "manual")]
