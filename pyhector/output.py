...
# FSO2 needs to be set before FSO2i or FSO2d when initialising, so we use an
# OrderedDict for Python versions < 3.6 where dictionaries keep insert order.

output = OrderedDict([('C2F6_halocarbon.hc_concentration',
  ...
  ('ocean.atm_ocean_flux_HL',
   {'component': 'ocean',
    'description': 'flux of carbon between the atmosphere and high latitude surface box',
    'unit': 'Pg C/yr',
    'variable': 'atm_ocean_flux_HL'}),
  ('ocean.atm_ocean_flux_LL',
   {'component': 'ocean',
    'description': 'flux of carbon between the atmosphere and low latitude surface box',
    'unit': 'Pg C/yr',
  ...
  ('simpleNbox.atmos_c_residual',
   {'component': 'simpleNbox',
    'description': 'the difference between calculated CO2 and and prescribed CO2 when running with prescribed CO2 concentrations',
    'unit': 'Pg C',
