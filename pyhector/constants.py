...
variables = {
    ...
    "NAT_EMISSIONS_N2O": "N2ON_emissions",
    "CONVERSION_N2O": "UC_N2O",
    "INITIAL_LIFETIME_N2O": "TN2O0",
    "LIFETIME_N2O": "TAU_N2O",
    "LIFETIME_OH": "TAU_OH",
    ...
    "HEAT_FLUX": "heatflux",
    "HEAT_UPTAKE_EFF": "kappa",
    "MAX_HEAT_UPTAKE_EFF": "k_max",
    "KAPPA50_TEMP": "t_mid",
    "MIN_HEAT_UPTAKE_EFF": "k_min",
    "SLOPE_HEAT_UPTAKE_EFF": "slope",
    "CO3_LL": "CO3_LL",
    "CO3_HL": "CO3_HL",
    ...
    "SOILC": "soil_c",
    "ANTHRO_EMISSIONS": "anthroEmissions",
    "LUC_EMISSIONS": "lucEmissions",
    "CO2FERT": "co2fert",
